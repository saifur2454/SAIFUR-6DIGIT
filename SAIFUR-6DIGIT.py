# DECRYPTED BY SR
# Github : https://github.com/saifur2454
 #!/usr/bin/python
# -*- coding: utf-8
 # uncompyle6 version 3.7.4
# Python bytecode 2.7
# Decompiled from: Python 2.7.18 (default, jan 15 2022, 08:48:00) 
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : SAIFUR RAHMAN VAI'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;96m[SAIFUR-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 15 Days]\x1b[0m \n'
